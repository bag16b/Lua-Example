...
function  scene:create(event)
	...
	{
	    params = {
	        background = display.newImage("GRASS_BACKGROUND.png", display.contentCenterX, display.contentCenterY),
	        ground = display.newImage("GRASS_GROUND.png",display.contentCenterX,display.contentCenterY),
	        groundphysics = "GRASS_GROUND",
	        gravity = 30,
